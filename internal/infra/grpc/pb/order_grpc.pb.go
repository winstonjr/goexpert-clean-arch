...
func (c *orderServiceClient) ListOrder(ctx context.Context, in *Blank, opts ...grpc.CallOption) (*OrderList, error) {
	out := new(OrderList)
...
func (UnimplementedOrderServiceServer) ListOrder(context.Context, *Blank) (*OrderList, error) {
...
func _OrderService_ListOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).ListOrder(ctx, req.(*Blank))
	}
	return interceptor(ctx, in, info, handler)
}
